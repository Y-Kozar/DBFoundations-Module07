...
-- 03/12/2025,Yuliya Kozar,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_YKozar')
	 Begin 
	  Alter Database [Assignment07DB_YKozar] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_YKozar;
	 End
	Create Database Assignment07DB_YKozar;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_YKozar;
...
Select P.ProductName, IntentoryDate = DateName(MM, I.InventoryDate) + ',' + DateName(YY, I.InventoryDate), InventoryCount = I.Count
From vProducts as P
Join vInventories as I
On P.ProductID = I.ProductID
Order by 1, InventoryDate Asc, 3;
go
